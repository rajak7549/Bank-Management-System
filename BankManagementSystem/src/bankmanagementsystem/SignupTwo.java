...
public class SignupTwo extends  JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String incomecategory[]={"Null","< 1,50,000","<2,50,000","5,00,000","Up 10,10,000"};
        ...
        String educationValues[]={"Non-Graduation","Graduate","Post-Graduation","MBBS","Other"};
